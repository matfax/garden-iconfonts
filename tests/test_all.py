...
class Tests(unittest.TestCase):
    ...
    def test_create_fontdict_file(self):
        res = iconfonts.create_fontdict_file(
            "tests/iconfont_sample.css", "tests/iconfont_sample.fontd"
        )
        self.assertEqual(
            res,
            {
    ...
    def test_register(self):
        iconfonts.register(
            "name", "tests/iconfont_sample.ttf", "tests/iconfont_sample.fontd"
        )
    ...
    def test_icon(self):
        ...
        self.assertEqual("[font=tests/iconfont_sample.ttf]%s[/font]" % chr(59397), r)
        r = iconfonts.icon("icon-comment", 20)
        self.assertEqual(
            "[size=20][font=tests/iconfont_sample.ttf]%s[/font][/size]" % chr(59397), r
        )
