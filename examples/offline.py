...
BoxLayout:
    ...
    kivysome.enable("https://kit.fontawesome.com/045c3333e7.js", group=FontGroup.SOLID, font_folder="../fonts", cached=True)
    # By specifying `cached=True`, kivysome will work offline after the first execution. This only works if a fixed version
    # was specified in the kit.
